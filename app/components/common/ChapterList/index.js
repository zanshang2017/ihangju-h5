...
class ChapterList extends React.Component {
    ...
    render() {
        ...
        var userInfoId = locStorageUserInfo.id;
        ...
        if (!this._chapterMes.chapters || this._chapterMes.chapters.length < 1) {
            ...
            var arr = [];
            if(locStorageProjectInfo[userInfoId]) {
                for (var i in locStorageProjectInfo[userInfoId][this.projectId]) {
                    arr.push(locStorageProjectInfo[userInfoId][this.projectId][i]);
                }   
            }
